...
import { carregarItens, excluir, itens, itensError, itensLoading } from '../store/itens'
...
async function confirmarExclusao() {
  ...
  try {
    ...
    mostrarSnackbar('Nao foi possivel remover o item. Tente novamente.', 'error')
  } finally {
...
onMounted(async () => {
  ...
  if (itensError.value) {
    mostrarSnackbar('Nao foi possivel carregar os itens.', 'error')
  }
